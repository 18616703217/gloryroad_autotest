...
public class CasesBasicController extends BaseController {
    ...
    @ResponseBody
    public ResponseModel insert(@RequestBody CasesBasic casesBasic, HttpServletRequest request) {
    ...
    @ResponseBody
    public ResponseModel update(@RequestBody CasesBasic casesBasic, HttpServletRequest request) {
        Map<String, String> messageMap = Maps.newHashMap();
